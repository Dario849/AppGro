...
export default defineConfig(({ command }) => {
	const publicBasePath = '/var/www/.'; // Change if deploying under a nested public path. Needs to end with a /. See https://vitejs.dev/guide/build.html#public-base-path
