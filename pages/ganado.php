                ...
                <div id="datos">
                    ...
                    <div>
                        ...
                        <fieldset>
                            ...
                            Nacimiento: <input type="date" name="nacimiento"
                                value="<?= $ganado['fecha_nacimiento'] ?? '' ?>"><br>
                    ...
                    <fieldset>
                        ...
                        Subdivisión: <input type="text" name="subdivision"
                            value="<?= $ganado['ubicacion'] ?? '' ?>"><br>
                        ...
                        <div id="vacunas">
                            <div>
                                <input type="text" name="vacuna_nombre[]" placeholder="Nombre"
                                    value="<?= $ganado['nombre_vacuna'] ?? '' ?>">
                                <input type="date" name="vacuna_fecha[]"
                                    value="<?= $ganado['fecha_vacuna'] ?? '' ?>"><br>
                            </div>
                        </div>
                        <button type="button" onclick="abrirModalVacunas(<?= $ganado['id'] ?>)">Ver Historial de
                            Vacunas</button>
